...
spotfire.webPlayer.Application = function(
    ...
    customizationInfo)
{
    var app = new spotfire.webPlayer.InternalApplication(webPlayerServerRootUrl, customizationInfo, "", "", false);
 ...
 */spotfire.webPlayer.InternalApplication=function(n,t,i,r,u){function a(){return}function it(n){var t=/^(https?:\/\/)(?:[a-zA-Z0-9\-.]+@[a-zA-Z0-9\-.]+:)?(\[[a-zA-Z0-9:]+\])(:[0-9]+)?(.*)$/i.exec(n)||/^(https?:\/\/)(?:[a-zA-Z0-9\-.]+@[a-zA-Z0-9\-.]+:)?([a-zA-Z0-9\-.]+)(:[0-9]+)?(.*)$/i.exec(n);if(t){var i=t[1],u=t[2],r=t[3]||"";return i==="http://"&&r===":80"||i==="https://"&&r===":443"?i+u:i+u+r}return null}function l(){if(y&&c.length>0&&(e===null||e.isLoaded())){var n=c.shift();if(e===null)e=n,n.loadDocument();else if(e.isLoaded())while(n)n.loadDocument(e),n=c.shift()}}function rt(n){var t=JSON.parse(n.data);if(s&&s.contentWindow===n.source){if(h!==n.origin){f(spotfire.webPlayer.errorCodes.ERRORINTERNAL,"Disregading message from an unknown source. Expected source is '"+h+"', was '"+n.origin+"'.");return}t.method==="proxyWindowLoaded"?(y=!0,l()):t.method==="documentLoaded"?o.forEach(function(n){if(n.elementId===t.elementId)n.onLoadSuccess(t.documentId,t.documentViewId,t.uri)}):t.method==="openFailed"?o.forEach(function(n){if(n.elementId===t.elementId)n.onLoadFailed(t.error)}):t.method==="logoutFailed"?f(spotfire.webPlayer.errorCodes.ERRORINTERNAL,"Logout failed."):t.method==="loggedOut"&&v()}}function ut(){window.addEventListener("message",rt);h=it(n)||window.location.protocol+"//"+window.location.hostname+(window.location.port?":"+window.location.port:"");s=document.createElement("iframe");s.id="openProxyFrame";s.style.display="none";window.setTimeout(function(){s===null&&f(spotfire.webPlayer.errorCodes.ERROROPEN,"Could not create the API proxy. Make sure that web application URL '"+n+"' is correct.")},w);var t=n+"render/9dB8CAgQQzUXkZzaLY/OpenProxy.aspx";s.src=t;document.body.appendChild(s);s.contentWindow.location.href=s.src}function d(){return o.every(function(n){return n.isIdle()})}function g(){return o.length>0}function ft(n){var i=o.indexOf(n),t;if(i>=0&&o.splice(i,1),n===e)for(e=null,t=0;t<o.length;t++)if(o[t].isLoaded()){e=o[t];break}l()}function p(t,a,y){function yt(n){typeof n=="function"?st.push(n):f(spotfire.webPlayer.errorCodes.ERRORDOCUMENT,"The provided callback is invalid.")}function pt(){it?(nt=!1,w.contentWindow.postMessage(JSON.stringify({method:"closeAnalysis"}),h)):f(spotfire.webPlayer.errorCodes.ERRORCLOSE,"Document busy.")}function wt(n){var t=g.length;return g[t]=n,t}function bt(n){for(var i=[],t=0;t<n.length;t++)i[t]=typeof n[t]=="function"?wt(n[t]):n[t];return JSON.stringify(i)}function kt(){if(nt)try{window.sessionStorage.setItem("waid_"+i+"_"+t,p);window.sessionStorage.setItem("wavid_"+i+"_"+t,d)}catch(n){console.log("Could not store current state: "+n)}}function dt(){try{p=window.sessionStorage.getItem("waid_"+i+"_"+t);d=window.sessionStorage.getItem("wavid_"+i+"_"+t);window.sessionStorage.removeItem("waid_"+i+"_"+t);window.sessionStorage.removeItem("wavid_"+i+"_"+t)}catch(n){}p&&d?tt=!0:(p=null,d=null)}function lt(){if(nt&&w&&w.contentWindow)for(var t=function(n){return function(){f(spotfire.webPlayer.errorCodes.ERRORINTERNAL,"The server did not respond to request '"+n+"' in a timely fashion.")}},n=ot.pop();n;)n.requestId=window.setTimeout(t(n.functionName),ct),w.contentWindow.postMessage(JSON.stringify(n),h),n=ot.pop()}function et(n,t,i){var r={method:"apply",nodeType:n,functionName:t,args:bt(i)};ot.push(r);lt()}function at(r){var u=d,f=!1,e;r&&(p=r.documentId(),u=r.documentViewId(),f=!0,tt=!0);e={method:"open",rootUrl:n,analysisPath:i,parameters:ht,customization:y,documentId:p,documentViewId:u,spawnView:f,domain:document.domain,elementId:t};s.contentWindow.postMessage(JSON.stringify(e),h)}function gt(n,t,i){if(p&&p!==n){f(spotfire.webPlayer.errorCodes.ERRORINTERNAL,"Invalid DocumentId.");return}for(p=n,d=t,w=document.createElement("iframe"),w.style.cssText="border:0;margin:0;padding:0;width:100%;height:100%",w.src=i;ut.hasChildNodes();)ut.removeChild(ut.lastChild);ut.appendChild(w)}function ni(n){if(tt){p=null;d=null;tt=!1;rt===e?at():(c.push(rt),l());return}it=!0;f(spotfire.webPlayer.errorCodes.ERROROPEN,n)}function ti(n,t,i){var r=function(n){var t,i;return Array.isArray(n)?(t=[],n.forEach(function(n){t.push(r(n))}),t):n.type==="DataTable"?new spotfire.webPlayer.DataTable(et,n.dataTableName):n.type==="DataColumn"?new spotfire.webPlayer.DataColumn(et,n.dataTableName,n.dataColumnName,n.dataType):n.type==="FilteringScheme"?(i=r(n.dataTables),i!==null?new spotfire.webPlayer.FilteringScheme(et,n.filteringSchemeName,i):null):null},u;typeof g[n]=="function"?i?(u=r(t),u!==null?g[n](u):f(spotfire.webPlayer.errorCodes.ERRORINTERNAL,"Unkown type '"+t.type+"'.")):g[n](JSON.parse(t)):f(spotfire.webPlayer.errorCodes.ERRORINTERNAL,"The registered callback '"+n+"' seems to be an invalid JavaScript function.")}function ii(n){var t,i,r;if(w&&w.contentWindow===n.source){if(h!==n.origin){f(spotfire.webPlayer.errorCodes.ERRORINTERNAL,"Disregading message from an unknown source. Expected source is '"+h+"', was '"+n.origin+"'.");return}if(t=JSON.parse(n.data),t.method==="documentUpdated"){for(i=0,i=0;i<st.length;i++)st[i]();return}if(t.method==="analysisReady"){if(p!==t.documentId||d!==t.documentViewId){f(spotfire.webPlayer.errorCodes.ERRORINTERNAL,"Could not create a unique document.");return}nt=!0;tt=!1;l();it=!0;b(rt.publicApi);lt();return}if(t.method==="apiResult"){ti(t.id,t.args,t.parseArgs);return}if(t.method==="apiRequestReceipt"&&window.clearTimeout(t.requestId),t.method==="analysisClosed"){nt=!1;t.closedReason==="ScheduledUpdates"?g.length>0&&(g=[],f(spotfire.webPlayer.errorCodes.ERRORCALLBACKS,"The analysis is reloading (reason: "+t.closedReason+"). There were registered callbacks that needs to be re-added.")):t.closedReason==="DifferentServer"||t.closedReason==="Restart"||t.closedReason==="Stale"?(p=null,r=!1,o.forEach(function(n){r=r||n.hasCallbacks();n.clearInternalState()}),e=null,c=o.slice(0),l(),r>0&&f(spotfire.webPlayer.errorCodes.ERRORCALLBACKS,"The analysis is reloading (reason: "+t.closedReason+"). There were registered callbacks that needs to be re-added.")):(it=!0,ft(rt),k(rt));return}if(t.method==="userLoggedOut"){v();return}if(t.method==="ajaxError"){f(spotfire.webPlayer.errorCodes.ERRORINTERNAL,t.message+"\n"+t.details);return}if(t.method==="apiError"){f(t.code||spotfire.webPlayer.errorCodes.ERRORINTERNAL,t.message);return}}}function ri(){typeof a=="number"?ht+="SetPage(pageIndex="+a+");":typeof a=="string"&&(ht+='SetPage(pageTitle="'+a+'");');u&&(dt(),window.addEventListener("beforeunload",kt));window.addEventListener("message",ii)}function ui(){nt=!1;w.parentNode.removeChild(w);w=null;g=[];p=null;d=null}function fi(){return g.length>0}var ot=[],st=[],p,d,tt=!1,g=[],w,it=!1,ht=r||"",rt=this,ct=12e4,nt=!1,ut=document.getElementById(t),vt;if(ut===null){f(spotfire.webPlayer.errorCodes.ERROROPEN,"The element '"+t+"' does not exist.");return}ri();this.loadDocument=at;this.onLoadSuccess=gt;this.onLoadFailed=ni;this.onDocumentReady=yt;this.isIdle=function(){return it};this.isLoaded=function(){return nt};this.documentId=function(){return p};this.documentViewId=function(){return d};this.clearInternalState=ui;this.hasCallbacks=fi;this.elementId=t;this.closeDocument=pt;this.apply=et;Object.defineProperty(this,"_requestTimeout",{set:function(n){ct=n}});vt=new spotfire.webPlayer.Document(this);this.publicApi=vt}function nt(n){if(n instanceof p)o.push(n),c.push(n),l();else throw"Internal error. Trying to add wrong type of document";}var tt=JSON.parse(JSON.stringify(t)),e=null,o=[],w=12e4,s=null,y=!1,c=[],h=null;Object.defineProperty(this,"analysisDocument",{get:function(){return e?e.publicApi:null}});Object.defineProperty(this,"analysisDocuments",{get:function(){return o.map(function(n){return n.publicApi})}});Object.defineProperty(this,"_openProxyTimeout",{set:function(n){w=n}});var b=a,k=a,f=a,v=a;this.openDocument=function(t,r,u){if(!n||n.length<=0)return f(spotfire.webPlayer.errorCodes.ERROROPEN,"The web application URL is null or empty."),null;if(!i||i.length<=0)return f(spotfire.webPlayer.errorCodes.ERROROPEN,"The analysis path is null or empty."),null;n.charAt(n.length-1)!=="/"&&(n+="/");var e=new p(t,r,JSON.parse(JSON.stringify(u||tt)));return nt(e),e.publicApi};this.open=function(u,e,o){if(i=u,r=o||"",d()&&!g()){if(!n||n.length<=0){f(spotfire.webPlayer.errorCodes.ERROROPEN,"The web application URL is null or empty.");return}n.charAt(n.length-1)!=="/"&&(n+="/");nt(new p(e,null,t))}else f(spotfire.webPlayer.errorCodes.ERROROPEN,"Application busy or user not authenticated or document already opened.")};this.close=function(){g()&&d()?(e=null,o.forEach(function(n){n.closeDocument()})):f(spotfire.webPlayer.errorCodes.ERRORCLOSE,"Application busy or no document opened.")};this.logout=function(){if(y)s.contentWindow.postMessage(JSON.stringify({method:"logout"}),h);else{var n=this;setTimeout(function(){n.logout()},100)}};this.onOpened=function(n){b=function(t){n(t)}};this.onClosed=function(n){k=function(t){n(i,t)}};this.onError=function(n){f=n};this.onLoggedOut=function(n){v=function(){n.call(this);v=a}};ut()}}()