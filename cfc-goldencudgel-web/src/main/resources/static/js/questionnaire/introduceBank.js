...
function queryQuestionaires(curPage){
	...
	$.ajax({
	    ...
	    type:"post",
	    data:{"questionName":questionName,"startDate":startDate,"endDate":endDate,"curPage":curPage,"introduceType":introduceType},
	    datatype: "html",
...
function viewAddQuestionnaire(){
    ...
    window.location.href = context_path + "/questionnaire/viewAddQuestionnaire?introduceType="+introduceType;
}
...
/*function viewEditQueston(obj){
    ...
    window.location.href = context_path + "/questionnaire/viewEditQuestionnaireCredit?introduceType="+introduceType+"&questionnaireId="+questionanaireId;
}*/
function viewEditQueston(obj){
	var questionanaireId = $(obj).attr("questionId");
	if(questionanaireId==""||questionanaireId=="undefined"){
	...
	//window.location.href = context_path + "/questionnaire/viewEditQuestionnaire?introduceType="+introduceType+"&questionnaireId="+questionanaireId+"&forAuditFlag="+forAuditFlag+"&viewForAudit="+viewForAudit+"&createUserCode="+createUserCode+"&auditStatus="+auditStatus+"&addDelUpdateFlag="+addDelUpdateFlag;
