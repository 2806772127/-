...
(function(t, e) {
    ...
    t.widget.extend = function(i) {
        for (var n, o, a = s.call(arguments, 1), r = 0, l = a.length; l > r; r++) for (n in a[r]) o = a[r][n],
    ...
    t.widget.bridge = function(i, n) {
        ...
        t.fn[i] = function(a) {
            ...
            h = this;
            return a = !r && l.length ? t.widget.extend.apply(null, [a].concat(l)) : a,
    ...
    t.fn.position = function(e) {
        ...
        this.each(function() {
            ...
            e.using && (h = function(t) {
                ...
                c > d && d > r(i + s) && (l.horizontal = "center"),
                p > g && g > r(o + n) && (l.vertical = "middle"),
                l.important = a(r(i), r(s)) > a(r(o), r(n)) ? "horizontal": "vertical",
    ...
    t.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(e, i) {
            ...
            for (u = d.snapElements.length - 1; u >= 0; u--) r = d.snapElements[u].left,
            l = r + d.snapElements[u].width,
            h = d.snapElements[u].top,
            c = h + d.snapElements[u].height,
            r - g > b || m > l + g || h - g > _ || v > c + g || !t.contains(d.snapElements[u].item.ownerDocument, d.snapElements[u].item) ? (d.snapElements[u].snapping && d.options.snap.release && d.options.snap.release.call(d.element, e, t.extend(d._uiHash(), {
    ...
    t.widget("ui.resizable", t.ui.mouse, {
        ...
        _create: function() {
            ...
            this._renderAxis = function(e) {
                ...
                this.elementIsWrapper && this.originalElement[0].nodeName.match(/textarea|input|select|button/i) && (s = t(this.handles[i], this.element), n = /sw|ne|nw|se|n|s/.test(i) ? s.outerHeight() : s.outerWidth(), o = ["padding", /ne|nw|n/.test(i) ? "Top": /se|sw|s/.test(i) ? "Bottom": /^e$/.test(i) ? "Right": "Left"].join(""), e.css(o, n), this._proportionallyResize()),
        ...
        _mouseStop: function(e) {
            ...
            r = parseInt(p.element.css("left"), 10) + (p.position.left - p.originalPosition.left) || null, l = parseInt(p.element.css("top"), 10) + (p.position.top - p.originalPosition.top) || null, h.animate || this.element.css(t.extend(a, {
                top: l,
                left: r
            })), p.helper.height(p.size.height), p.helper.width(p.size.width), this._helper && !h.animate && this._proportionallyResize()),
        ...
        _updateVirtualBoundaries: function(t) {
            ...
            (this._aspectRatio || t) && (e = a.minHeight * this.aspectRatio, o = a.minWidth / this.aspectRatio, s = a.maxHeight * this.aspectRatio, n = a.maxWidth / this.aspectRatio, e > a.minWidth && (a.minWidth = e), o > a.minHeight && (a.minHeight = o), a.maxWidth > s && (a.maxWidth = s), a.maxHeight > n && (a.maxHeight = n)),
            this._vBoundaries = a
        },
    ...
    t.ui.plugin.add("resizable", "containment", {
        ...
        resize: function(e) {
            ...
            h.left < (a._helper ? l.left: 0) && (a.size.width = a.size.width + (a._helper ? a.position.left - l.left: a.position.left - u.left), p && (a.size.height = a.size.width / a.aspectRatio), a.position.left = r.helper ? l.left: 0),
    ...
    t.ui.plugin.add("resizable", "alsoResize", {
        ...
        resize: function(e, i) {
            ...
            "object" != typeof o.alsoResize || o.alsoResize.nodeType ? l(o.alsoResize) : t.each(o.alsoResize,
            function(t, e) {
                l(t, e)
            })
        },
    ...
    t.widget("ui.button", {
        ...
        _create: function() {
            ...
            function() {
                return a.disabled ? !1 : (t(this).addClass("ui-state-active"), e = this, n.document.one("mouseup",
                function() {
                    e = null
                }), undefined)
    ...
    t.extend(i.prototype, {
        ...
        _optionDatepicker: function(i, s, a) {
            ...
            c.settings) : this._get(c, s) : null: (o = s || {},
            "string" == typeof s && (o = {},
            o[s] = a), c && (this._curInst === c && this._hideDatepicker(), r = this._getDateDatepicker(i, !0), h = this._getMinMaxDate(c, "min"), l = this._getMinMaxDate(c, "max"), n(c.settings, o), null !== h && o.dateFormat !== e && o.minDate === e && (c.settings.minDate = this._formatDate(c, h)), null !== l && o.dateFormat !== e && o.maxDate === e && (c.settings.maxDate = this._formatDate(c, l)), "disabled" in o && (o.disabled ? this._disableDatepicker(i) : this._enableDatepicker(i)), this._attachments(t(i), c), this._autoSize(c), this._setDate(c, r), this._updateAlternate(c), this._updateDatepicker(c)), e)
        },
        ...
        _hideDatepicker: function(e) {
            var i, s, n, a, r = this._curInst; ! r || e && r !== t.data(e, o) || this._datepickerShowing && (i = this._get(r, "showAnim"), s = this._get(r, "duration"), n = function() {
        ...
        parseDate: function(i, s, n) {
            ...
            for (a = 0; i.length > a; a++) if (y)"'" !== i.charAt(a) || w("'") ? x() : y = !1;
            ...
            case "@":
                ...
                break;
            case "!":
                h = new Date((D("!") - this._ticksTo1970) / 1e4),
                m = h.getFullYear(),
                _ = h.getMonth() + 1,
                v = h.getDate();
                break;
        ...
        _generateHTML: function(t) {
            ...
            Z = t.drawMonth - X,
            te = t.drawYear;
            if (0 > Z && (Z += 12, te--), J) for (e = this._daylightSavingAdjust(new Date(J.getFullYear(), J.getMonth() - q[0] * q[1] + 1, J.getDate())), e = V && V > e ? V: e; this._daylightSavingAdjust(new Date(te, Z, 1)) > e;) Z--,
            0 > Z && (Z = 11, te--);
                ...
                for (k = "", this.maxRows = 4, x = 0; q[1] > x; x++) {
                    if (C = this._daylightSavingAdjust(new Date(te, Z, t.selectedDay)), M = " ui-corner-all", T = "", $) {
                        ...
                        case 0:
                            ...
                            break;
                        case q[1] - 1 : T += " ui-datepicker-group-last",
                    ...
                    z += "<th" + ((w + c + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'": "") + ">" + "<span title='" + d[I] + "'>" + p[I] + "</span></th>";
                    for (T += z + "</tr></thead><tbody>", P = this._getDaysInMonth(te, Z), te === t.selectedYear && Z === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, P)), S = (this._getFirstDayOfMonth(te, Z) - c + 7) % 7, E = Math.ceil((S + P) / 7), N = $ ? this.maxRows > E ? this.maxRows: E: E, this.maxRows = N, H = this._daylightSavingAdjust(new Date(te, Z, 1 - S)), W = 0; N > W; W++) {
                        for (T += "<tr>", A = u ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(H) + "</td>": "", w = 0; 7 > w; w++) R = m ? m.apply(t.input ? t.input[0] : null, [H]) : [!0, ""],
                        O = H.getMonth() !== Z,
                        F = O && !v || !R[0] || V && V > H || J && H > J,
                        A += "<td class='" + ((w + c + 6) % 7 >= 5 ? " ui-datepicker-week-end": "") + (O ? " ui-datepicker-other-month": "") + (H.getTime() === C.getTime() && Z === t.selectedMonth && t._keyEvent || b.getTime() === H.getTime() && b.getTime() === C.getTime() ? " " + this._dayOverClass: "") + (F ? " " + this._unselectableClass + " ui-state-disabled": "") + (O && !_ ? "": " " + R[1] + (H.getTime() === G.getTime() ? " " + this._currentClass: "") + (H.getTime() === L.getTime() ? " ui-datepicker-today": "")) + "'" + (O && !_ || !R[2] ? "": " title='" + R[2].replace(/'/g, "&#39;") + "'") + (F ? "": " data-handler='selectDay' data-event='click' data-month='" + H.getMonth() + "' data-year='" + H.getFullYear() + "'") + ">" + (O && !_ ? "&#xa0;": F ? "<span class='ui-state-default'>" + H.getDate() + "</span>": "<a class='ui-state-default" + (H.getTime() === L.getTime() ? " ui-state-highlight": "") + (H.getTime() === G.getTime() ? " ui-state-active": "") + (O ? " ui-priority-secondary": "") + "' href='#'>" + H.getDate() + "</a>") + "</td>",
                    ...
                    Z++,
                    Z > 11 && (Z = 0, te++),
                    T += "</tbody></table>" + ($ ? "</div>" + (q[0] > 0 && x === q[1] - 1 ? "<div class='ui-datepicker-row-break'></div>": "") : ""),
                    k += T
                }
                y += k
            }
        ...
        _generateMonthYearHeader: function(t, e, i, s, n, a, o, r) {
            ...
            if (v || (b += y + (!a && m && _ ? "": "&#xa0;")), !t.yearshtml) if (t.yearshtml = "", a || !_) b += "<span class='ui-datepicker-year'>" + i + "</span>";
            else {
    ...
    t.effects.effect.explode = function(e, i) {
        ...
        b = [];
        for (a = 0; u > a; a++) for (h = m.top + a * _, c = a - (u - 1) / 2, o = 0; d > o; o++) r = m.left + o * v,
        l = o - (d - 1) / 2,
    ...
    t.effects.effect.size = function(e, i) {
        ...
        ("box" === g || "both" === g) && (o.from.y !== o.to.y && (_ = _.concat(d), a.from = t.effects.setTransition(a, d, o.from.y, a.from), a.to = t.effects.setTransition(a, d, o.to.y, a.to)), o.from.x !== o.to.x && (_ = _.concat(u), a.from = t.effects.setTransition(a, u, o.from.x, a.from), a.to = t.effects.setTransition(a, u, o.to.x, a.to))),
        ...
        a.css(a.from),
        ("content" === g || "both" === g) && (d = d.concat(["marginTop", "marginBottom"]).concat(c), u = u.concat(["marginLeft", "marginRight"]), l = r.concat(d).concat(u), a.find("*[width]").each(function() {
            var i = t(this),
            s = {
                height: i.height(),
                width: i.width(),
            ...
            o.from.y !== o.to.y && (i.from = t.effects.setTransition(i, d, o.from.y, i.from), i.to = t.effects.setTransition(i, d, o.to.y, i.to)),
